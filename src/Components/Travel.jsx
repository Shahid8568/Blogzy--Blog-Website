...
const Travel = ({blogs}) => {
    const travelData = blogs.filter((e)=> e.category === "Travel");
    return (
      <>
    ...
    <h1 className='mt-5' style={{color:"white",textDecoration:"underline",display:"block",margin:"10px 55px"}}>Travel Blogs :-</h1>
